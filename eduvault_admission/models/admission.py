...
class OpAdmission(models.Model):
    ...
    def get_student_vals(self):
        is_global_student_user=self.env['ir.config_parameter'].get_param('eduvault_admission.global_student_user')
        for student in self:
            student_user=False
    ...
    def open_student(self):
        form_view = self.env.ref('eduvault_core.view_op_student_form')
        tree_view = self.env.ref('eduvault_core.view_op_student_tree')
        value = {
    ...
    def get_import_templates(self):
        return [{
            ...
            'template': '/eduvault_admission/static/xls/op_admission.xls'
        }]
